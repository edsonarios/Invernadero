...
var cuentas_routing_module_1 = require("./cuentas-routing.module");
    ...
    CuentasModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                cuentas_routing_module_1.CuentasRoutingModule,
                theme_1.NbBadgeModule,
            ],
            declarations: cuentas_routing_module_1.routedComponents.slice(),
        })
    ], CuentasModule);
