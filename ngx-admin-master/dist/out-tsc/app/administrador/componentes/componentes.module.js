...
var componentes_routing_module_1 = require("./componentes-routing.module");
    ...
    ComponentesModule = __decorate([
        core_1.NgModule({
            imports: [
                ...
                componentes_routing_module_1.ComponentesRoutingModule,
            ],
            declarations: componentes_routing_module_1.routedComponents.slice(),
        })
    ], ComponentesModule);
