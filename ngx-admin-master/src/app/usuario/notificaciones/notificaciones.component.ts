...
export class NotificacionesComponent implements OnInit {
    ...
    */
    ...
    obtener() {
        ...
        this.notiE
            .notificationError(this.idInv, this.contacto.value)
    ...
    obtener2() {
        ...
        this.notiE
            .notificationFunci(this.idInv, this.contacto.value)
