...
export class InvernaderosEditarComponent {
   ...
   minuto3;
   segundo3;
   constructor(private router: Router, private invService: InvernaderoService) {
      console.log('invernaderos_editar funcionando');
      ...
      this.invService.show(this.inv).subscribe(
         (response) => {
            ...
            console.log(
               '[invernadero_editar][invService]',
               this.tiempoFuncionMotor
            );
